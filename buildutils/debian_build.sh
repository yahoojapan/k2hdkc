...
#
cp ${MYSCRIPTDIR}/k2hdkc.service ${EXPANDDIR}/debian/k2hdkc.service || exit 1
echo "buildutils/k2hdkc-service-helper usr/libexec"				>> ${EXPANDDIR}/debian/${PACKAGE_NAME}.install || exit
echo "buildutils/k2hdkc-service-helper.conf etc/antpickax"		>> ${EXPANDDIR}/debian/${PACKAGE_NAME}.install || exit
echo "buildutils/k2hdkc.ini.example etc/antpickax"				>> ${EXPANDDIR}/debian/${PACKAGE_NAME}.install || exit
echo "buildutils/override.conf.k2hdkc_example etc/antpickax"	>> ${EXPANDDIR}/debian/${PACKAGE_NAME}.install || exit
