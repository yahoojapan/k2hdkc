...
#ifndef	K2HDKCCOMADDSUBKEY_H
#define	K2HDKCCOMADDSUBKEY_H
...
//---------------------------------------------------------
class K2hdkcComAddSubkey : public K2hdkcCommand
{
	...
	public:
		...
		bool CommandSend(const unsigned char* pkey, size_t keylength, const unsigned char* psubkey, size_t subkeylength, const unsigned char* pskeyval, size_t skeyvallength, bool checkattr = true, const char* encpass = NULL, const time_t* expire = NULL);
		bool CommandSend(const unsigned char* pkey, size_t keylength, const unsigned char* psubkey, size_t subkeylength, const unsigned char* pskeyval, size_t skeyvallength, bool checkattr, const char* encpass, const time_t* expire, dkcres_type_t* prescode);
		bool GetResponseData(dkcres_type_t* prescode) const;
};

#endif	// K2HDKCCOMADDSUBKEY_H
