...
#ifndef	K2HDKCCOMDELSUBKEY_H
#define	K2HDKCCOMDELSUBKEY_H
...
//---------------------------------------------------------
class K2hdkcComDelSubkey : public K2hdkcCommand
{
	...
	public:
		...
		bool CommandSend(const unsigned char* pkey, size_t keylength, const unsigned char* psubkey, size_t subkeylength, bool is_subkeys, bool checkattr = true);
		bool CommandSend(const unsigned char* pkey, size_t keylength, const unsigned char* psubkey, size_t subkeylength, bool is_subkeys, bool checkattr, dkcres_type_t* prescode);
		bool GetResponseData(dkcres_type_t* prescode) const;
};

#endif	// K2HDKCCOMDELSUBKEY_H
