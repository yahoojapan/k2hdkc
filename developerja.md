...
k2hdkcクラスタにキー名を指定して、そのキーをCAS（Comapre And Swap）コマンドとして利用できるように初期化する関数群です。
...
#### 返り値
成功すればtureを返し、失敗した場合にはfalseを返します。
...
#### 返り値
成功すればtureを返し、失敗した場合にはfalseを返します。サブキーを持たない場合にもfalseを返します。
...
#### 返り値
成功すればtureを返し、失敗した場合にはfalseを返します。属性情報を持たない場合にもfalseを返します。  
...
#### 返り値
成功すればtureを返し、失敗した場合にはfalseを返します。指定した属性情報を持たない場合にもfalseを返します。
